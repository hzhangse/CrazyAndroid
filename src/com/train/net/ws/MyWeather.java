...
import com.train.R;
import com.train.async.AsyncWorkHandler;
...
public class MyWeather extends Activity {
	...
	private Runnable provinceWorker;
	private Runnable cityWorker;
	private Runnable wetherWorker;
	
	AsyncWorkHandler getProvinceWorkHandler = new AsyncWorkHandler() {
		@Override
		protected void onCompleteWork(Object obj) {
			List<String> provinces = (List<String>) obj;
			ListAdapter adapter = new ListAdapter(MyWeather.this, provinces);
			// 使用Spinner显示省份列表
			provinceSpinner.setAdapter(adapter);
			this.removeWorker(provinceWorker);
		}
	...
	AsyncWorkHandler getCityListByProvinceWorkHandler = new AsyncWorkHandler() {
		@Override
		protected void onCompleteWork(Object obj) {
	...
	AsyncWorkHandler showWetherWorkHandler = new AsyncWorkHandler() {
		@Override
		protected void onCompleteWork(Object obj) {
			SoapObject detail = (SoapObject)(obj);
			showWeather(detail);
			this.removeWorker(wetherWorker);
		}
		protected Object excuteTask() {
			SoapObject detail = WebServiceUtil.getWeatherByCity(citySpinner.getSelectedItem().toString());	
			return detail;
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ws_weather);
		...
		//List<String> provinces = WebServiceUtil.getProvinceList();
		getProvinceWorkHandler.execute();
		...
		provinceSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> source, View parent,
				...
				getCityListByProvinceWorkHandler.execute();
			}
